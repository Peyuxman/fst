      ...
      <form action="registro-programa" class="form" method ="POST">
                ...
                <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" id="nombre" placeholder="Ej:Análisis y Desarrollo de Software" name="nombre" class="input">
                    </div>
                    <div class="col-md-6">
                      <label for="duracionHoras">Abreviación:</label> <br>
                      <input type="text" id="nomAbreviacion" placeholder="Ej: ADSO" name="nomAbreviacion" class="input" required>
                  </div>
                    
                    <div class="col-md-6">
                      <label for="numCompetencias">Número de Competencias:</label> <br>
                      <input type="number" id="numCompetencias" placeholder="Ej: 20" name="numCompetencias" class="input" required>
                  </div>
                    <div class="col-md-6">
                        <label for="duracionMeses">Duración del Programa (meses):</label> <br>
                        <input type="number" id="duracionMeses" placeholder="Ej: 7" class="input" name="duracionMeses" required><br><br>
                    </div>
                    <div class="col-md-6">
                        <label for="duracionHoras">Duración del Programa (horas):</label> <br>
                        <input type="number" id="duracionHoras" placeholder="Ej: 36" name="duracionHoras" class="input" required>
                    </div>
                    <div class="col-md-12">
                        <label for="duracionHoras">Red Tecnológica</label> <br>
                        <input type="text" id="redTecno" placeholder="Ej: TECNOLOGÍAS DE LA INFORMACIÓN, DISEÑO Y DESARROLLO DE SOFTWARE" name="redTecno" class="input" required>
                    </div>
