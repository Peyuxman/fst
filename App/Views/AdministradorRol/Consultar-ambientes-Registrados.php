...
require_once ROOT_PATH.'/App/Controllers/ambientesController.php';
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Instructores Registradas</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="./dashboard-administrador">Home</a></li>
          <li class="breadcrumb-item"><a href="./dashboard-administrador">Ambientes</a></li>
        ...
        <div class="col-lg-12">
          ...
          <div class="card tabla-consultar">
            <div class="card-body tabla-consultar">
              <h5 class="card-title">Consultar Instructores Registradas</h5>
